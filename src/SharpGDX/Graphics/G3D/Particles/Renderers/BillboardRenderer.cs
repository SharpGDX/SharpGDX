 ...
 * @author Inferno */
public class BillboardRenderer : ParticleControllerRenderer<BillboardControllerRenderData, BillboardParticleBatch> {

	public BillboardRenderer () 
    : base(new BillboardControllerRenderData())
    {
	...
	public override bool isCompatible (ParticleBatch<BillboardControllerRenderData> batch) {
		return batch is BillboardParticleBatch;
	}
