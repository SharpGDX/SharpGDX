...
public class NinePatch {
	static public readonly int TOP_LEFT = 0;
	static public readonly int TOP_CENTER = 1;
	static public readonly int TOP_RIGHT = 2;
	static public readonly int MIDDLE_LEFT = 3;
	static public readonly int MIDDLE_CENTER = 4;
	static public readonly int MIDDLE_RIGHT = 5;
	static public readonly int BOTTOM_LEFT = 6;
	/** Indices for the {@link #NinePatch(TextureRegion...)} constructor. */
	static public readonly int BOTTOM_CENTER = 7; // This field has the javadoc comment because it appears first in the javadocs.
	static public readonly int BOTTOM_RIGHT = 8;

	static private readonly Color tmpDrawColor = new ();
