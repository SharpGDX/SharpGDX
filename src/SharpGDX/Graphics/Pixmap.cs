 ...
 * @author badlogicgames@gmail.com */
	...
	public class FormatUtils
	{
		public static int toGdx2DPixmapFormat(Format? format)
		{
			...
			if (format == Format.LuminanceAlpha) return Gdx2DPixmap.GDX2D_FORMAT_LUMINANCE_ALPHA;
			if (format == Format.RGB565) return Gdx2DPixmap.GDX2D_FORMAT_RGB565;
			if (format == Format.RGBA4444) return Gdx2DPixmap.GDX2D_FORMAT_RGBA4444;
			if (format == Format.RGB888) return Gdx2DPixmap.GDX2D_FORMAT_RGB888;
			if (format == Format.RGBA8888) return Gdx2DPixmap.GDX2D_FORMAT_RGBA8888;
			throw new GdxRuntimeException("Unknown Format: " + format);
		}

		public static Format fromGdx2DPixmapFormat(int format)
		{
			if (format == Gdx2DPixmap.GDX2D_FORMAT_ALPHA) return Format.Alpha;
			if (format == Gdx2DPixmap.GDX2D_FORMAT_LUMINANCE_ALPHA) return Format.LuminanceAlpha;
			if (format == Gdx2DPixmap.GDX2D_FORMAT_RGB565) return Format.RGB565;
			if (format == Gdx2DPixmap.GDX2D_FORMAT_RGBA4444) return Format.RGBA4444;
			if (format == Gdx2DPixmap.GDX2D_FORMAT_RGB888) return Format.RGB888;
			if (format == Gdx2DPixmap.GDX2D_FORMAT_RGBA8888) return Format.RGBA8888;
