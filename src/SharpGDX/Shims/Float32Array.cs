...
public class Float32Array {
	...
	public Float32Array (int capacity) 
	: this(true, capacity)
	{
	...
	public Float32Array (bool ordered, int capacity) {
	 ...
	 * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
	 *           memory copy. */
	public Float32Array (bool ordered, float[] array, int startIndex, int count) 
	: this(ordered, count)
	{
	...
	public void addAll (Float32Array array) {
		addAll(array.items, 0, array.size);
	}

	public void addAll (Float32Array array, int offset, int length) {
	...
	public bool removeAll (Float32Array array) {
		int size = this.size;
		int startSize = size;
		float[] items = this.items;
	...
	public override bool Equals (Object? obj) {
		...
		if (!(obj is Float32Array)) return false;
		Float32Array array = (Float32Array)obj;
	...
	/** @see #Float32Array(float[]) */
	static public Float32Array with (float[] array) {
