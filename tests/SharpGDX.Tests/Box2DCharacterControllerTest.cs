...
//
//public class Box2DCharacterControllerTest : GdxTest , IApplicationListener {
//
//	readonly static float MAX_VELOCITY = 14f;
//	boolean jump = false;
//	World world;
//	Body player;
...
//				Console.WriteLine("jump before: " + player.getLinearVelocity());
//				player.setTransform(pos.x, pos.y + 0.01f, 0);
//				player.applyLinearImpulse(0, 40, pos.x, pos.y, true);
//				Console.WriteLine("jump, " + player.getLinearVelocity());
//			}
//		}
//
//		// update platforms
...
//
//	public override bool TouchDown (int x, int y, int pointerId, int button) {
