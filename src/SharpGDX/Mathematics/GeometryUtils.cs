...
public sealed class GeometryUtils {
	...
	static private readonly Vector2 tmp1 = new Vector2(), tmp2 = new Vector2(), tmp3 = new Vector2();
	...
	static public bool colinear (float x1, float y1, float x2, float y2, float x3, float y3) {
	...
	static public bool isClockwise (float[] polygon, int offset, int count) {
	...
	static public bool isCCW (float[] polygon, int offset, int count) {
