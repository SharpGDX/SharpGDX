...
public class EarClippingTriangulator {
	static private readonly int CONCAVE = -1;
	static private readonly int CONVEX = 1;

	private readonly ShortArray indicesArray = new ShortArray();
	private short[] indices;
	private float[] vertices;
	private int vertexCount;
	private readonly IntArray vertexTypes = new IntArray();
	private readonly ShortArray triangles = new ShortArray();
