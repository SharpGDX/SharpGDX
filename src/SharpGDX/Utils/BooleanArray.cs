...
public class BooleanArray {
	 ...
	 * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
	 *           memory copy. */
	public BooleanArray (bool ordered, bool[] array, int startIndex, int count)
	: this(ordered, count)
	{
	...
	public void add (bool value1, bool value2) {
		bool[] items = this.items;
	...
	public void add (bool value1, bool value2, bool value3) {
		bool[] items = this.items;
	...
	public void add (bool value1, bool value2, bool value3, bool value4) {
		bool[] items = this.items;
	...
	public bool removeAll (BooleanArray array) {
		int size = this.size;
		int startSize = size;
		bool[] items = this.items;
	...
	public override bool Equals (Object? obj) {
		...
		if (!(obj is BooleanArray)) return false;
		BooleanArray array = (BooleanArray)obj;
		if (!array.ordered) return false;
		int n = size;
		if (n != array.size) return false;
		bool[] items1 = this.items, items2 = array.items;
		for (int i = 0; i < n; i++)
	...
	static public BooleanArray with (bool[] array) {
