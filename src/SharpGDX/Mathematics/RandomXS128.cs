 ...
 * @author davebaol */
	...
	private static readonly double NORM_DOUBLE = 1.0 / (1L << 53);

	/** Normalization constant for float. */
	private static readonly double NORM_FLOAT = 1.0 / (1L << 24);
	...
	{
		// TODO: Need to investigate the unchecked code
		x ^= x >>> 33;
