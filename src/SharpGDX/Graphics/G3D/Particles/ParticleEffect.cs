 ...
 * @author inferno */
public class ParticleEffect : IDisposable, ResourceData<ParticleEffect>.Configurable {
	...
	public ParticleEffect () {
		controllers = new Array<ParticleController>(true, 3, typeof(ParticleController));
	}
	...
	public BoundingBox getBoundingBox () {
		...
		bounds.inf();
		foreach (ParticleController emitter in controllers)
	 ...
	 * assigned. */
	public void setBatch (Array<ParticleBatch<ParticleControllerRenderData>> batches) {
		foreach (ParticleController controller in controllers) {
	...
	public void save (AssetManager assetManager, ResourceData<ParticleEffect> data) {
		foreach (ParticleController controller in controllers) {
	...
	public void load (AssetManager assetManager, ResourceData<ParticleEffect> data) {
		int i = 0;
		foreach (ParticleController controller in controllers) {
