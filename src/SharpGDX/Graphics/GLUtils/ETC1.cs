...
public class ETC1 {
	 ...
	 * @author mzechner */
	public sealed class ETC1Data : Disposable {
		/** the width in pixels **/
		public readonly int width;
		/** the height in pixels **/
		public readonly int height;
		/** the optional PKM header and compressed image data **/
		public readonly ByteBuffer compressedData;
		...
		private void checkNPOT () {
			if (!MathUtils.isPowerOfTwo(width) || !MathUtils.isPowerOfTwo(height)) {
					// TODO: This was originally: System.out.println
					Console.WriteLine("ETC1Data " + "warning: non-power-of-two ETC1 textures may crash the driver of PowerVR GPUs");
			}
		}
	...
	*/
	...
	static extern int getWidthPKM (ByteBuffer header, int offset); /*
	...
	*/
	...
	static extern int getHeightPKM (ByteBuffer header, int offset); /*
	...
	*/
	 ...
	 * @param offset the offset in bytes to the PKM header from the ByteBuffer's start
	 * @return the width stored in the PKM header */
	static extern bool isValidPKM (ByteBuffer header, int offset); /*
	...
	*/
	...
	private static extern void decodeImage (ByteBuffer compressedData, int offset, ByteBuffer decodedData, int offsetDec,
	...
	*/
	...
	private static extern ByteBuffer encodeImage (ByteBuffer imageData, int offset, int width, int height, int pixelSize); /*
	...
	*/
	 ...
	 * @param pixelSize the pixel size, either 2 (RGB565) or 3 (RGB888)
	 * @return a new direct native order ByteBuffer containing the compressed image data */
	private static extern ByteBuffer encodeImagePKM (ByteBuffer imageData, int offset, int width, int height, int pixelSize); /*
		int compressedSize = etc1_get_encoded_data_size(width, height);
