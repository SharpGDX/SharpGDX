using System;
using SharpGDX.Utils.Compression.LZ;
...
namespace SharpGDX.Utils.Compression.LZMA
{
	...
	class LenDecoder {
		...
		public int Decode (RangeCoder.Decoder rangeDecoder, int posState)  // TODO: throws IOException
			{
	...
	internal class LiteralDecoder {
		internal class Decoder2 {
			...
			public byte DecodeNormal (RangeCoder.Decoder rangeDecoder) // TODO:  throws IOException
			{
				int symbol = 1;
				do
		...
		internal Decoder2 GetDecoder (int pos, byte prevByte) {
	...
	void Init () // TODO: throws IOException 
{
	...
	public bool Code (InputStream inStream, OutputStream outStream, long outSize) // TODO:  throws IOException 
{
