...
public class PixmapPacker : IDisposable
{
     ...
     * @see PixmapPacker#PixmapPacker(int, int, Format, int, bool, bool, bool, PackStrategy) */
    ...
    public void updateTextureAtlas(TextureAtlas atlas, TextureFilter minFilter, TextureFilter magFilter,
        bool useMipMaps)
    {
        lock (this)
    ...
    public void updateTextureAtlas(TextureAtlas atlas, TextureFilter minFilter, TextureFilter magFilter,
        bool useMipMaps, bool useIndexes)
    {
        throw new NotImplementedException();
        //lock (this)
        //{
        ...
        //				TextureAtlas.AtlasRegion region = new TextureAtlas.AtlasRegion(page.texture, (int)rect.x,
        //					(int)rect.y,
    ...
    /** Calls {@link Page#updateTexture(TextureFilter, TextureFilter, bool) updateTexture} for each page and adds a region to
     * the specified array for each page texture. */
    public void updateTextureRegions(Array<TextureRegion> regions, TextureFilter minFilter, TextureFilter magFilter,
        bool useMipMaps)
    {
        throw new NotImplementedException();
        //lock (this)
    ...
    /** Calls {@link Page#updateTexture(TextureFilter, TextureFilter, bool) updateTexture} for each page. */
    ...
    public bool getDuplicateBorder()
    {
        return duplicateBorder;
    }

    public void setDuplicateBorder(bool duplicateBorder)
    {
        this.duplicateBorder = duplicateBorder;
    }
    ...
    public class Page
    {
        internal OrderedMap<String, PixmapPackerRectangle> rects = new();
        internal Pixmap image;
        Texture texture;
        Array<String> addedRects = new();
        bool dirty;
         ...
         * @see #updateTexture(TextureFilter, TextureFilter, bool) */
    ...
    public class GuillotineStrategy : IPackStrategy
    {
        ...
        sealed class Node
        {
            ...
            public readonly Rectangle rect = new Rectangle();
            public bool full;
        }

        class GuillotinePage : Page
        {
            Node root;
    ...
    public class PixmapPackerRectangle : Rectangle
    {
        ...
        PixmapPackerRectangle(int x, int y, int width, int height, int left, int top, int originalWidth,
            int originalHeight)
            : base(x, y, width, height)
        {
