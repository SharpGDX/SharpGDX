...
namespace SharpGDX.Shims
{
   abstract class FileSystem {
     ...
     */
    public abstract bool isInvalid(File f);
    ...
    //@Native 
    public static readonly int BA_EXISTS    = 0x01;
    //@Native 
    public static readonly int BA_REGULAR   = 0x02;
    //@Native 
    public static readonly int BA_DIRECTORY = 0x04;
    //@Native 
    public static readonly int BA_HIDDEN    = 0x08;
     ...
     */
    public bool hasBooleanAttributes(File f, int attributes) {
        return (getBooleanAttributes(f) & attributes) == attributes;
    }

    //@Native
    public static readonly int ACCESS_READ    = 0x04;
    //@Native
    public static readonly int ACCESS_WRITE   = 0x02;
    //@Native 
    public static readonly int ACCESS_EXECUTE = 0x01;
     ...
     */
    public abstract bool createFileExclusively(String pathname);// throws IOException;
    ...
    /* -- Disk usage -- */
    //@Native 
    public static readonly int SPACE_TOTAL  = 0;
    //@Native 
    public static readonly int SPACE_FREE   = 1;
    //@Native 
    public static readonly int SPACE_USABLE = 2;
