...
public class ShapeRenderer : Disposable {
	...
	{
		public static int getGlType(ShapeType type)
		{
			return (int)type;
		}
		...
		private readonly ImmediateModeRenderer renderer;
	...
	private readonly Vector2 tmp = new Vector2();
	...
	public void setAutoShapeType (bool autoShapeType) {
	...
	public void begin (ShapeType? type) {
		...
		renderer.begin(combinedMatrix, ShapeTypeUtils.getGlType(shapeType ?? throw new NotImplementedException("ShapeType was null")));
	}
