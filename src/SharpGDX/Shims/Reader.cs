...
namespace SharpGDX.Shims
{
	...
	public abstract class Reader : ICloseable
	{
		 ...
		 * @see #markSupported()
		 * @see #reset() */
		public void mark(int readLimit) // TODO:   throws IOException
		{
 ...
 * @throws IOException if this reader is closed or some other I/O error occurs. */
		public int read() // TODO:   throws IOException
		{
			lock (_lock)
			{
 ...
 * @throws IOException if this reader is closed or some other I/O error occurs. */
		public int read(char[] buf) // TODO:   throws IOException
		{
 ...
 * @return the number of characters read or -1 if the end of the reader has been reached.
 * @throws IOException if this reader is closed or some other I/O error occurs. */
		public abstract int read(char[] buf, int offset, int count); // TODO:   throws IOException;
		...
		public bool ready() // TODO:  throws IOException
		{
			return false;
		}
 ...
 * @see #mark(int)
 * @see #markSupported() */
		public void reset() // TODO:  throws IOException
		{
			throw new IOException();
		}
		 ...
		 * @see #markSupported()
		 * @see #reset() */
		public long skip(long count) // TODO:  throws IOException
		{
			if (count < 0)
			{
 ...
 * @throws ReadOnlyBufferException if {@code target} is read-only. */
		public int read(CharBuffer target) // TODO: throws IOException
		{
			if (null == target)
			{
				throw new NullPointerException();
