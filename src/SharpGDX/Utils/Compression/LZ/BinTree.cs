...
namespace SharpGDX.Utils.Compression.LZ
{
	...
	static readonly int kHash2Size = 1 << 10;
	static readonly int kHash3Size = 1 << 16;
	static readonly int kBT2HashSize = 1 << 16;
	static readonly int kStartMaxLen = 1;
	static readonly int kHash3Offset = kHash2Size;
	static readonly int kEmptyHashValue = 0;
	static readonly int kMaxValForNormalize = (1 << 30) - 1;
	...
	public bool Create (int historySize, int keepAddBufferBefore, int matchMaxLen, int keepAddBufferAfter) {
	...
	public int GetMatches (int[] distances) // TODO: throws IOException 
		{
		int lenLimit;
	...
	public void Skip (int num) // TODO: throws IOException
		{
		do {
			int lenLimit;
			if (_pos + _matchMaxLen <= _streamPos)
