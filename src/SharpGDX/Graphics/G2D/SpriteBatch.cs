 ...
 * @author Nathan Sweet */
    public class SpriteBatch : IBatch
    {
        ...
        public virtual void Draw(Texture texture, float x, float y, float originX, float originY, float width,
        ...
        public virtual void Draw(Texture texture, float x, float y, float width, float height, int srcX, int srcY,
            int srcWidth,
        ...
        public virtual void Draw(Texture texture, float x, float y, float width, float height, float u, float v,
            float u2, float v2)
        {
            if (!drawing) throw new IllegalStateException("SpriteBatch.begin must be called before draw.");
        ...
        public virtual void Draw(TextureRegion region, float x, float y, float originX, float originY, float width,
            float height,
