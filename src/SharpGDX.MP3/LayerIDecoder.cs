 ...
 */
public class LayerIDecoder : FrameDecoder {
	...
	internal static readonly float[] scalefactors = {2.00000000000000f, 1.58740105196820f, 1.25992104989487f, 1.00000000000000f,
	 ...
	 * mode
	 */
	 class SubbandLayer1 : Subband {

		// Factors and offsets for sample requantization
		public static readonly float[] table_factor = {0.0f, 1.0f / 2.0f * 4.0f / 3.0f, 1.0f / 4.0f * 8.0f / 7.0f,
		...
		public static readonly float[] table_offset = {0.0f, (1.0f / 2.0f - 1.0f) * 4.0f / 3.0f, (1.0f / 4.0f - 1.0f) * 8.0f / 7.0f,
