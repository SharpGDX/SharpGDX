...
// * @author Jon Renner */
//public class SelectTest : GdxTest {
//	static PerformanceCounter perf = new PerformanceCounter("bench");
//	static bool verify; // verify and report the results of each selection
...
//			Console.WriteLine("origin dummy: " + originDummy);
//			Console.WriteLine("TEST FAILURE: " + "idx: " + idx + " does not equal (k - 1): " + (k - 1));
//			throw new GdxRuntimeException("test failed");
//		}
//	}
//
