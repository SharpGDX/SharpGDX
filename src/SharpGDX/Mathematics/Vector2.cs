...
public class Vector2 : IVector<Vector2> {
	private static readonly long serialVersionUID = 913902788239530931L;

	public readonly static Vector2 X = new Vector2(1, 0);
	public readonly static Vector2 Y = new Vector2(0, 1);
