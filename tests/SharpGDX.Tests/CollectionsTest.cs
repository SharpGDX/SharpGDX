...
//public class CollectionsTest : GdxTest {
...
//			throw new GdxRuntimeException(a.getClass().getSimpleName() + " !equals() failed (not symmetric):\n" + b + "\n==\n" + a);
//		if (a.hashCode() == b.hashCode())
//			Console.WriteLine("Warning: " + a.getClass().getSimpleName() + " hashCode() may be incorrect:\n" + a + "\n==\n" + b);
//	}
//
...
//		{
//			Console.WriteLine(IntIntMap.class);
...
//		}
//		{
//			Console.WriteLine(IntMap.class);
