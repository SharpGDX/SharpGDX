    ...
    public class TextureAtlas : IDisposable
    {
        ...
        public class TextureAtlasData
        {
            ...
            public void load(FileHandle packFile, FileHandle imagesDir, bool flip)
            {
                ...
                {
                    parse = (Page page) => { page.format = Enum.Parse<Pixmap.Format>(entry[1]); }
                });
                ...
                {
                    parse = (Page page) => { page.pma = entry[1].Equals("true"); }
                });
        ...
        public class AtlasSprite : Sprite
        {
            ...
            public override void SetBounds(float x, float y, float width, float height)
            {
                ...
                base.SetBounds(x + region.offsetX, y + region.offsetY, packedWidth * widthRatio,
