 ...
 * </ul>
 * @since Android 1.0 */
	public abstract class ByteBuffer : Buffer , IComparable<ByteBuffer>, StringToByteBuffer {
		...
		protected Endianness _order = Endianness.BIG_ENDIAN;
	...
	{
		return _order == Endianness.BIG_ENDIAN ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN;
	}
	...
	{
		_order = byteOrder == ByteOrder.BIG_ENDIAN ? Endianness.BIG_ENDIAN : Endianness.LITTLE_ENDIAN;
		return this;
	}
