 ...
 */
public  sealed class SynthesisFilter {
	private float[] v1;
	private float[] v2;
	...
	private static readonly double MY_PI = 3.14159265358979323846;
	 ...
	 */
	static private Object deserializeArray (InputStream @in, Type elemType, int length) {
		...
		Type arrayElemType = cls.GetElementType();
