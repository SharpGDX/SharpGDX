...
public class Decal {
	...
	private static readonly int VERTEX_SIZE = 3 + 1 + 2;
	/** Size of the decal in floats. It takes a float[SIZE] to hold the decal. */
	public static readonly int SIZE = 4 * VERTEX_SIZE;
	...
	internal protected float[] vertices = new float[SIZE];
	internal protected Vector3 position = new Vector3();
	...
	internal protected DecalMaterial material;
	...
	readonly static Vector3 dir = new Vector3();
	...
	public static readonly int X1 = 0;
	public static readonly int Y1 = 1;
	public static readonly int Z1 = 2;
	public static readonly int C1 = 3;
	public static readonly int U1 = 4;
	public static readonly int V1 = 5;
	public static readonly int X2 = 6;
	public static readonly int Y2 = 7;
	public static readonly int Z2 = 8;
	public static readonly int C2 = 9;
	public static readonly int U2 = 10;
	public static readonly int V2 = 11;
	public static readonly int X3 = 12;
	public static readonly int Y3 = 13;
	public static readonly int Z3 = 14;
	public static readonly int C3 = 15;
	public static readonly int U3 = 16;
	public static readonly int V3 = 17;
	public static readonly int X4 = 18;
	public static readonly int Y4 = 19;
	public static readonly int Z4 = 20;
	public static readonly int C4 = 21;
	public static readonly int U4 = 22;
	public static readonly int V4 = 23;
	 ...
	 * @return Created decal */
	public static Decal newDecal (TextureRegion textureRegion, bool hasTransparency) {
		return newDecal(textureRegion.getRegionWidth(), textureRegion.getRegionHeight(), textureRegion,
			hasTransparency ? IGL20.GL_SRC_ALPHA : DecalMaterial.NO_BLEND,
			hasTransparency ? IGL20.GL_ONE_MINUS_SRC_ALPHA : DecalMaterial.NO_BLEND);
	}
...
// from RGBA,..
	 ...
	 * @param hasTransparency Whether or not this sprite will be treated as having transparency (transparent png, etc.)
	 * @return Created decal */
	public static Decal newDecal (float width, float height, TextureRegion textureRegion, bool hasTransparency) {
		return newDecal(width, height, textureRegion, hasTransparency ? IGL20.GL_SRC_ALPHA : DecalMaterial.NO_BLEND,
			hasTransparency ? IGL20.GL_ONE_MINUS_SRC_ALPHA : DecalMaterial.NO_BLEND);
	}
