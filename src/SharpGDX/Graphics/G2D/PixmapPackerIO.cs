...
public static class ImageFormatUtils
{
	...
	public void save (FileHandle file, PixmapPacker packer) // TODO: throws IOException 
	{
	 ...
	 * @throws IOException if the atlas file can not be written */
	public void save (FileHandle file, PixmapPacker packer, SaveParameters parameters)  // TODO:throws IOException 
	{
		...
		//		FileHandle pageFile = file.sibling(file.nameWithoutExtension() + "_" + (++index) + ImageFormatUtils.getExtension(parameters.format));
		...
		//					imageIndex = int.Parse(matcher.group(2));
		//				}
		//			}
